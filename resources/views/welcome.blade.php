    ...
    <main id="main">
        ...
        <section id="about" class="about">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <img src="images/DSC_0050.JPG" class="img-fluid" alt="">
                    </div>
        ...
        <section>
            ...
            <div class="container" data-aos="fade-up">
                <div style="text-align: center">
                    <h2>Sign to support the initiative <a class="button"
                            href="https://europa.eu/citizens-initiative/_en" type="_blank">here</a>
                    </h2>
                </div>
            </div>
            <hr>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row skills-content">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="progress">
                            <span class="skill"> <i class="val">9%</i></span>
        ...
        <section id="resume" class="resume">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <h3 class="resume-title">Plastics are invented</h3>
                        <div class="resume-item pb-0">
                            <h4> <span style="color: dodgerblue">1907</span> - A new material</h4>
                            <p><em>Leo Baekeland invents the first fully synthetic plastic, called "bakelite"</em></p>
                        </div>

                        <h3 class="resume-title">From a promising material, to an enviromental crisis</h3>
                        <div class="resume-item">
                            <h4> <span style="color: dodgerblue">1995</span> - Landfill overflow scandal</h4>
                        ...
                        <div class="resume-item">
                            <h4> <span style="color: dodgerblue">1980</span> - Plastic carbon footprint.</h4>
                            <p><em>Rochester Institute of Technology, Rochester, NY</em></p>
                    ...
                    <div class="col-lg-6">
                        <h3 class="resume-title">Policies implemented</h3>
                        <div class="resume-item">
                            <h4> <span style="color: dodgerblue">2011</span> - Safe Ocean Act.</h4>
                        ...
                        <div class="resume-item">
                            <h4> <span style="color: dodgerblue">2021</span> - Single Plastics Ban.</h4>
                            <p><em>European Union</em></p>
                            <ul>
                                <li>Lead in the design, development, and implementation of the graphic, layout, and
                                    production communication materials</li>
